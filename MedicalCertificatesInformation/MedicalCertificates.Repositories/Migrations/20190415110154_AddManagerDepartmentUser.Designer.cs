...
namespace MedicalCertificates.Repositories.Migrations
{
    ...
    [Migration("20190415110154_AddManagerDepartmentUser")]
    partial class AddManagerDepartmentUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalCertificates.DomainModel.Models.DefaultUser", b =>
                {
                    b.HasBaseType("MedicalCertificates.DomainModel.Models.ApplicationUser");

                    b.HasDiscriminator().HasValue("DefaultUser");
                });

            modelBuilder.Entity("MedicalCertificates.DomainModel.Models.DepartmentManagerUser", b =>
                {
                    b.HasBaseType("MedicalCertificates.DomainModel.Models.ApplicationUser");

                    b.HasDiscriminator().HasValue("DepartmentManagerUser");
                });
            ...
            modelBuilder.Entity("MedicalCertificates.DomainModel.Models.Department", b =>
                {
                    b.HasOne("MedicalCertificates.DomainModel.Models.DepartmentManagerUser", "DepartmentManager")
                        .WithOne("Department")
                        .HasForeignKey("MedicalCertificates.DomainModel.Models.Department", "DepartmentManagerId")
                        .OnDelete(DeleteBehavior.SetNull);
                });

            modelBuilder.Entity("MedicalCertificates.DomainModel.Models.Group", b =>
                {
                    b.HasOne("MedicalCertificates.DomainModel.Models.DefaultUser", "ApplicationUser")
                        .WithMany("Groups")
